...
React.useEffect(() => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-slate-800 text-slate-200 border border-slate-700 max-w-2xl p-0">
        {/* Header */}
        ...
        {/* Body */}
        <div className="flex h-87.5 border-t border-slate-700">
          {/* Left Side - Categories */}
          <div className="w-1/3 border-r border-slate-700 p-4 space-y-1">
        ...
        {/* Footer */}
        <DialogFooter className="px-6 py-4 border-t border-slate-700 flex justify-end gap-3">
          <Button
            variant="outline"
