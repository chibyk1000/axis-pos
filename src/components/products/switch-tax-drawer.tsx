...
export default function SwitchTaxesDrawer({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange} direction="right">
      <DrawerContent className="w-full max-w-md bg-stone-50 dark:bg-stone-900 border-l border-stone-200 dark:border-stone-700 p-6">
        <DrawerHeader>
          <DrawerTitle className="text-stone-900 dark:text-white">Switch Taxes</DrawerTitle>
