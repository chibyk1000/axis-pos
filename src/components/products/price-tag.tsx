  ...
  return (
    <div className="h-screen w-screen bg-stone-50 dark:bg-stone-900 text-stone-900 dark:text-stone-100 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* LEFT PANEL */}
        <aside className="w-80 shrink-0 border-r border-stone-300 dark:border-stone-800 p-4 overflow-y-auto space-y-6">
          {/* Label size */}
          ...
          <Section title="Barcode">
            <Select defaultValue="ean13">
              <SelectTrigger className="bg-white dark:bg-stone-800">
          ...
          <Section title="Products">
            <div className="flex gap-2">
              ...
              <Input placeholder="Product name" className="bg-white dark:bg-stone-800" />
            </div>

            <div className="mt-4 text-xs text-stone-500 dark:text-stone-400 text-center">
          ...
          <Section title="Number of copies">
            <div className="flex items-center gap-2">
              ...
              <Input value="1" className="w-16 text-center bg-white dark:bg-stone-800" />
              <Button variant="secondary">+</Button>
            </div>
          </Section>
        ...
        {/* RIGHT PREVIEW */}
        <main className="flex-1 bg-stone-950 flex flex-col">
          {/* Toolbar */}
          <div className="h-10 flex items-center justify-between px-4 border-b border-stone-300 dark:border-stone-800">
            <div className="flex gap-2">
...
function Section({ title, children }: any) {
  return (
    <div className="space-y-3">
      <h3 className="text-xs font-semibold text-stone-500 dark:text-stone-400 uppercase">
        {title}
      </h3>
      {children}
    </div>
...
function TwoInputs({ a, b }: { a: string; b: string }) {
  return (
    <div className="grid grid-cols-2 gap-2">
      <Input placeholder={a} className="bg-white dark:bg-stone-800" />
      <Input placeholder={b} className="bg-white dark:bg-stone-800" />
    </div>
  );
}
